 ...
 * https://github.com/kcolemangt/llm-router/blob/859fea37d5691b34a6e3734ea273544c419f6ce2/utils/utils.go
...
func LogRequestResponse(logger *slog.Logger, req *http.Request, resp *http.Response, reqBody, respBody string) {
	if req != nil {
		// Log request headers
