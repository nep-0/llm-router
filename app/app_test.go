...
func TestGetClientWithMultipleModelsFromSameProvider(t *testing.T) {
	...
	kc1 := client.NewKeyClient("key1", "openai", openai.NewClientWithConfig(config1), 0, 0)

	config2 := openai.DefaultConfig("key2")
	kc2 := client.NewKeyClient("key2", "openai", openai.NewClientWithConfig(config2), 0, 0)
...
func TestGetClientSelectsLowestUsageAcrossAllCombinations(t *testing.T) {
	...
	kc1 := client.NewKeyClient("key1", "openai", openai.NewClientWithConfig(openai.DefaultConfig("key1")), 0, 0)
	kc2 := client.NewKeyClient("key2", "openai", openai.NewClientWithConfig(openai.DefaultConfig("key2")), 0, 0)
	kc3 := client.NewKeyClient("key3", "openai", openai.NewClientWithConfig(openai.DefaultConfig("key3")), 0, 0)
